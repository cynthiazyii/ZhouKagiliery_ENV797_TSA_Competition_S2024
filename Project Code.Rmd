...
### Output
```{r output}
for_dates <- seq(as.Date("2011-07-01"), as.Date("2011-12-31"), by = "day")
ETS_load <- ETS_fit$mean
ETS_output <- cbind.data.frame(for_dates, ETS_load)
